...
void WM8960_AnalogToDigital(void)
{
  WM8960_WriteData(1,WM8960_RESET,0x00);// R15
  WM8960_WriteData(1,WM8960_RESET,0x00);//
  WM8960_WriteData(1,WM8960_CLOCK1,0x00);//
  WM8960_WriteData(1,WM8960_DACCTL1,0x06);//
  WM8960_WriteData(1,0x07,0x42);  //
  WM8960_WriteData(1,0x08,0x04);  //BCLK 3.072
  WM8960_WriteData(1,0x09,0x00);  //
  WM8960_WriteData(1,0x15,0xc3);  //
  WM8960_WriteData(1,0x16,0x1c3);  //
  WM8960_WriteData(1,0x19,0x14c);  //
  WM8960_WriteData(1,0x1a,0x180);  //
  WM8960_WriteData(1,0x2b,0x50);  //
  WM8960_WriteData(1,0x2c,0x50);//
  WM8960_WriteData(1,0x30,0x40);//
  WM8960_WriteData(1,0x1b,0x00);//
}
