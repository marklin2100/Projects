...
enum TBCT {
  ...
  BCTReserved1,       // 10 Reserved for future
  BCTReserved2,       // 11 Reserved for future
  BCTReserved3,       // 12 Reserved for future
  BCTReserved4,       // 13 Reserved for future
  BCTPlayTrack        // 14 Command to play media player tracks
};
