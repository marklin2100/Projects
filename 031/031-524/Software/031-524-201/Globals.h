...
#define PIProject         524
#define PIPartNumber      201
#define PISettingsVersion   2
...
#define SD_PWR_ON()       SetBit(SD_PWR_PORT,SD_PWR)
#define SD_PWR_OFF()      ClearBit(SD_PWR_PORT,SD_PWR)
// SD
...
#define DongleLEDPort     PORTC
#define DongleLED         PC3
// Data direction registers

#define PortDirA          ((1 << XDCS) | (1 << XCS) | (1 << RS485DE))
#define PortDirB          ((1 << MP3Reset) | (1 << CS) | (1 << DD_SS) | (1 << MUSTBeOutput) | (1 << SD_PWR))
#define PortDirC          ((1 << Mute) | (1 << Sel0B) | (1 << Sel1B) | (1 << Sel0C) | (1 << Sel1C) | (1 << DongleLED))
...
enum TConfig {TwoBaysOneSource, OneBayTwoSources, TwoBaysTwoSources};
