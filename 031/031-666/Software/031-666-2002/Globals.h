...
#define PIProject         666
#define PIPartNumber      202
#define PISettingsVersion  0
...
#define CenterLEDs (1 << (CenterSelect - 1))

#define LeftBayBrightness   (1 << BCALeftBay)
#define CenterBayBrightness (1 << BCACenterBay)
#define RightBayBrightness  (1 << BCARightBay)
// Enumerated constants

// TODO: Redefine operational modes based on new spec when created.
enum TConfig {TwoBaysOneSource, OneBayTwoSources, TwoBaysTwoSources,OneBayOneSource,ThreeBaysOneSource,ThreeBaysTwoSources};
...
typedef struct {
  ...
  Uint8 DefaultVolume;
  Uint8 MaximumVolume;
  Uint8 IdleBrightness;
  Uint8 SelectedBrightness;
  Uint8 UnselectedBrightness;
} TProdDef;
